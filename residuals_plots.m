...
rng default;
ktry = 25;
Xtry = lhsdesign(ktry,2);
Ytry = feval(func, Xtry);
...
% ylabel('Standarized Residuals MLE', 'interpreter', 'latex')
% set(gca, 'FontSize', 15)
% 
% figure(5); clf;
% plot(y_mix, res_ind_mix, '.')
% xlabel('Fitted values', 'interpreter', 'latex')
% ylabel('Standarized Residuals mixture', 'interpreter', 'latex')
% set(gca, 'FontSize', 15)
% 
